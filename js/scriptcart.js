...
function showCart(data){
    ...
    for(var id in data) {
        ...
        table_cart +='<td class="sum_stroka'+data[id].id+'">'+data[id].sum+'</td>';
        table_cart +='</tr>';
    }
...
function POSTData(){
    ...
    mainCartElement.innerHTML = "Заказ оформлен! Детали заказа можно посмотреть в личном кабинете по кнопке История заказаов.";
    mainCartElement.style.color = "#FFC000";
    mainCartElement.style.fontsize = "24px";
    mainCartElement.style.textAlign = "center";
    mainCartElement.style.marginTop = "20px";
