...
<section id="edit-profile-form">
    ...
    <input type="text" id="user-name" name="user-name" value="<?php echo
    isset($_SESSION['login']) ? $_SESSION['login'] : ''; ?>"><br>
    <label for="age">Возраст:</label><br>
    <input type="text" id="user-age" name="user-age" value="<?php echo
    isset($_SESSION['age']) ? $_SESSION['age'] : ''; ?>"><br>
